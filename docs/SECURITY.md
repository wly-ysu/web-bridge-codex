...
- MCP registration updates only `[mcp_servers.pro_bridge_codex]` and preserves other servers.
...
- Do not publish `%LOCALAPPDATA%\pro_bridge_codex`, `.codex` backups, or ChatGPT profile data.
