...
|---|---|---|---|
| Windows 10/11 x64 | First release target | `%LOCALAPPDATA%\web-bridge-codex` | User-level PowerShell installer |
| macOS | Initial installer delivered | `~/Library/Application Support/web-bridge-codex` | Requires Python 3.11+, Chrome/Chromium, and first-run device validation |
| Linux | Initial installer delivered | `~/.local/share/web-bridge-codex` | Requires Python 3.11+, Chrome/Chromium, and distribution-specific validation |
